...
nextSlug: "/documentation/methods-and-parameters"   
---
...
<ol>
  ...
  <li>
    <b>Standardized Scoring System</b>
    <ul>
      <li>
      ...
      <li>
        Loom AI assigns accuracy score based on multiple evaluation metrics:
        <ul>
        </ul>
      </li>
    </ul>
